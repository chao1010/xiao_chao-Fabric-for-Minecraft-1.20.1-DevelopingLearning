...
public class BlueSlimeEntityRenderer extends MobEntityRenderer<BlueSlimeEntity, SlimeEntityModel<BlueSlimeEntity>> {

    private static final Identifier TEXTURE = new Identifier(ExampleMod.MOD_ID,"textures/entity/slime/blue_slime.png");
    ...
    public BlueSlimeEntityRenderer(EntityRendererFactory.Context ctx, EntityModelLayer layer, EntityModelLayer legArmorLayer) {
    ...
    @Override
    public Identifier getTexture(BlueSlimeEntity slimeEntity) {
        return TEXTURE;
    }
}
