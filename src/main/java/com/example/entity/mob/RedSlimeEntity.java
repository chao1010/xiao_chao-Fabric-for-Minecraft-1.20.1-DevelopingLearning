...
public class RedSlimeEntity extends MobEntity
        implements Monster {

    private static final TrackedData<Integer> SLIME_SIZE = DataTracker.registerData(RedSlimeEntity.class, TrackedDataHandlerRegistry.INTEGER);
    ...
    public RedSlimeEntity(EntityType<? extends RedSlimeEntity> entityType, World world) {
        super(entityType, world);
        this.moveControl = new RedSlimeEntity.SlimeMoveControl(this);
    }

    @Override
    protected void initGoals() {
        this.goalSelector.add(1, new RedSlimeEntity.SwimmingGoal(this));
        this.goalSelector.add(2, new RedSlimeEntity.FaceTowardTargetGoal(this));
        this.goalSelector.add(3, new RedSlimeEntity.RandomLookGoal(this));
        this.goalSelector.add(5, new RedSlimeEntity.MoveGoal(this));
    ...
    public void remove(Entity.RemovalReason reason) {
        ...
        if (!this.getWorld().isClient && i > 1 && this.isDead()) {
            ...
            for (int l = 0; l < k; ++l) {
                ...
                RedSlimeEntity slimeEntity = (RedSlimeEntity) this.getType().create(this.getWorld());
    ...
    public static DefaultAttributeContainer.Builder createRedSlimeAttributes() {
    ...
    public boolean canSpawn(WorldView world) {
        ...
        if (worldAccess.getDifficulty() != Difficulty.PEACEFUL){
            return !world.containsFluid(this.getBoundingBox()) && world.doesNotIntersectEntities(this) && worldAccess.getBiome(blockPos).isIn(ModBiomeTags.ALLOWS_SURFACE_RED_SLIME_SPAWNS) && random.nextFloat() < 0.5f && random.nextFloat() < worldAccess.getMoonSize() && worldAccess.getLightLevel(blockPos) <= random.nextInt(15);
        }
        return false;
    }
    ...
    static class SlimeMoveControl
        ...
        public SlimeMoveControl(RedSlimeEntity slime) {
            super(slime);
            this.slime = slime;
    ...
    static class SwimmingGoal
        ...
        public boolean canStart() {
            return (this.slime.isTouchingWater() || this.slime.isInLava()) && this.slime.getMoveControl() instanceof RedSlimeEntity.SlimeMoveControl;
        }
        ...
        public void tick() {
            ...
            if ((moveControl = this.slime.getMoveControl()) instanceof RedSlimeEntity.SlimeMoveControl) {
                RedSlimeEntity.SlimeMoveControl slimeMoveControl = (RedSlimeEntity.SlimeMoveControl)moveControl;
    ...
    static class FaceTowardTargetGoal
        ...
        public boolean canStart() {
            ...
            return this.slime.getMoveControl() instanceof RedSlimeEntity.SlimeMoveControl;
        }

        @Override
        public void start() {
            this.ticksLeft = RedSlimeEntity.FaceTowardTargetGoal.toGoalTicks(300);
            super.start();
        }
    ...
    static class RandomLookGoal
        ...
        @Override
        public boolean canStart() {
            return this.slime.getTarget() == null && (this.slime.isOnGround() || this.slime.isTouchingWater() || this.slime.isInLava() || this.slime.hasStatusEffect(StatusEffects.LEVITATION)) && this.slime.getMoveControl() instanceof RedSlimeEntity.SlimeMoveControl;
        }
    ...
    static class MoveGoal
        ...
        public void tick() {
            ...
            if (moveControl instanceof RedSlimeEntity.SlimeMoveControl) {
                RedSlimeEntity.SlimeMoveControl slimeMoveControl = (RedSlimeEntity.SlimeMoveControl)moveControl;
