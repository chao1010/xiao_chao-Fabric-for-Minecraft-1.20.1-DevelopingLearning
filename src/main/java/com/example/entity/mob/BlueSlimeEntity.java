...
public class BlueSlimeEntity extends MobEntity
        implements Monster {
    private static final TrackedData<Integer> SLIME_SIZE = DataTracker.registerData(BlueSlimeEntity.class, TrackedDataHandlerRegistry.INTEGER);
    ...
    public BlueSlimeEntity(EntityType<? extends BlueSlimeEntity> entityType, World world) {
        ...
        this.moveControl = new BlueSlimeEntity.SlimeMoveControl(this);
    }

    @Override
    protected void initGoals() {
        this.goalSelector.add(1, new BlueSlimeEntity.SwimmingGoal(this));
        this.goalSelector.add(2, new BlueSlimeEntity.FaceTowardTargetGoal(this));
        this.goalSelector.add(3, new BlueSlimeEntity.RandomLookGoal(this));
        this.goalSelector.add(5, new BlueSlimeEntity.MoveGoal(this));
    ...
    public void remove(Entity.RemovalReason reason) {
        ...
        if (!this.getWorld().isClient && i > 1 && this.isDead()) {
            ...
            for (int l = 0; l < k; ++l) {
                ...
                BlueSlimeEntity slimeEntity = (BlueSlimeEntity) this.getType().create(this.getWorld());
    ...
    public boolean canSpawn(WorldView world) {
        ...
        if (worldAccess.getDifficulty() != Difficulty.PEACEFUL){
            return !world.containsFluid(this.getBoundingBox()) && world.doesNotIntersectEntities(this) && worldAccess.getBiome(blockPos).isIn(ModBiomeTags.ALLOWS_SURFACE_BLUE_SLIME_SPAWNS);
        }
        return false;
    }
    ...
    static class SlimeMoveControl
        ...
        public SlimeMoveControl(BlueSlimeEntity slime) {
            super(slime);
            this.slime = slime;
    ...
    static class SwimmingGoal
        ...
        public SwimmingGoal(BlueSlimeEntity slime) {
            this.slime = slime;
        ...
        public boolean canStart() {
            return (this.slime.isTouchingWater() || this.slime.isInLava()) && this.slime.getMoveControl() instanceof BlueSlimeEntity.SlimeMoveControl;
        }
        ...
        public void tick() {
            ...
            if ((moveControl = this.slime.getMoveControl()) instanceof BlueSlimeEntity.SlimeMoveControl) {
                BlueSlimeEntity.SlimeMoveControl slimeMoveControl = (BlueSlimeEntity.SlimeMoveControl)moveControl;
    ...
    static class FaceTowardTargetGoal
        ...
        public FaceTowardTargetGoal(BlueSlimeEntity slime) {
            this.slime = slime;
        ...
        public boolean canStart() {
            ...
            return this.slime.getMoveControl() instanceof BlueSlimeEntity.SlimeMoveControl;
        }

        @Override
        public void start() {
            this.ticksLeft = BlueSlimeEntity.FaceTowardTargetGoal.toGoalTicks(300);
            super.start();
        }
    ...
    static class RandomLookGoal
        ...
        public RandomLookGoal(BlueSlimeEntity slime) {
            this.slime = slime;
            this.setControls(EnumSet.of(Goal.Control.LOOK));
        }
        ...
        @Override
        public boolean canStart() {
            return this.slime.getTarget() == null && (this.slime.isOnGround() || this.slime.isTouchingWater() || this.slime.isInLava() || this.slime.hasStatusEffect(StatusEffects.LEVITATION)) && this.slime.getMoveControl() instanceof BlueSlimeEntity.SlimeMoveControl;
        }
    ...
    static class MoveGoal
        ...
        public MoveGoal(BlueSlimeEntity slime) {
            this.slime = slime;
            this.setControls(EnumSet.of(Goal.Control.JUMP, Goal.Control.MOVE));
        }
        ...
        public void tick() {
            ...
            if (moveControl instanceof BlueSlimeEntity.SlimeMoveControl) {
                BlueSlimeEntity.SlimeMoveControl slimeMoveControl = (BlueSlimeEntity.SlimeMoveControl)moveControl;
